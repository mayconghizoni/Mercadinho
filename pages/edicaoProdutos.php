<?php
    ...
    if($_POST["selecionarProduto"] == ""){
        ...
        echo  "<script> alert('Selecione um produto para ser editado.');";
        echo "javascript:window.location='produtos.php'</script>";
        ...
        foreach($pdo->query("select * from produtos where id = $id") as $row){
            $nome = $row['nome'];
            $valor = $row['valor'];
            $qtd = $row['quantidade'];
            $imposto = $row['imposto_id'];
        }
...
<body>
    <header>
        <h1>Mercadinho da Soft - Edição de produtos</h1>
    ...
    <section>
        ...
        <form name="frmEditaProduto" id="frmEditaProduto" method="POST" action="../system/view/editar_produtos.php">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="nomeProduto" id="nomeProduto" value="<?php echo $nome ?>">
            </div>
            <div class="form-group">
                <label for="valorProduto">Valor do produto: </label>
                <input type="decimal" class="form-control" name="valorProduto" id="valorProduto" value="<?php echo $valor ?>">
            </div>
            <div class="form-group">
                <label for="quantidadeProduto">Quantidade do produto: </label>
                <input type="text" class="form-control" name="quantidadeProduto" id="quantidadeProduto" value="<?php echo $qtd ?>">
            </div>
